...
func New() *Set {
	...
	// Ensure all features are present in the entitlements. Our frontend expects
	// this. License bypass is applied during refresh so runtime feature wiring
	// still observes the transition from disabled to enabled.
